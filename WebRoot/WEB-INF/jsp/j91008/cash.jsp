		...
		<div class="content-view">
			<div class="charge-content">
				<div class="charge-row mui-row">
					...
					<div class="mui-col-xs-8 mui-text-right cash-row">1635442</div>	
				</div>	
				<div class="charge-row mui-row">
					<div class="mui-col-xs-4"><label>充值现金：</label></div>
					<div class="mui-col-xs-8"><input type="text" placeholder="请输入提现金额" class="cash-input"/></div>	
				</div>
				<div class="charge-row mui-row">
					<div class="mui-col-xs-4"><label>饲料：</label></div>
					<div class="mui-col-xs-8 mui-text-right cash-row colorred">10%</div>	
				</div>
				<div class="charge-row mui-row">
					<div class="mui-col-xs-5"><label>预计到账金额：</label></div>
					<div class="mui-col-xs-7 mui-text-right cash-row"></div>	
				</div>
				<!--<div class="charge-row mui-row">
					<div class="mui-col-xs-3"><label>银行卡：</label></div>
					<div class="mui-col-xs-9 mui-text-right cash-row">2544156874257441578</div>	
				</div>
				<div class="charge-row mui-row cash-pt">
					<div class="mui-col-xs-7"><label>支付宝或微信二维码：</label></div>
					<div class="mui-col-xs-5 cash-row ">
						<div class="cash-code"><img src="images/code.png" /> </div>
					</div>	
				</div>-->
