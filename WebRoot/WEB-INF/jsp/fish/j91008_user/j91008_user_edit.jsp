		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="j91008_user/${msg }.do" name="Form" id="Form" method="post">
						<input type="hidden" name="J91008_USER_ID" id="J91008_USER_ID" value="${pd.J91008_USER_ID}"/>
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								...
								<td><input type="number" name="MONEY" id="MONEY" value="${pd.MONEY}" maxlength="32" placeholder="这里输入钱" title="钱" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">爱心币:</td>
								<td><input type="number" name="LOVE_COIN" id="LOVE_COIN" value="${pd.LOVE_COIN}" maxlength="32" placeholder="这里输入爱心币" title="爱心币" style="width:98%;"/></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><input type="number" name="IS_ADOPTION" id="IS_ADOPTION" value="${pd.IS_ADOPTION}" maxlength="32" placeholder="这里输入1 表示领养，0 表示未领养" title="1 表示领养，0 表示未领养" style="width:98%;"/></td>
							</tr>
							<tr>
