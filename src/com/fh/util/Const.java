...
public class Const {
	...
	public static final String NO_INTERCEPTOR_PATH = ".*/((login)|(logout)|(code)|(app)|(weixin)|(static)|(main)|(websocket)|(uploadImgs)|(fish)|(j91008)|(rotation_chart)|(uploadFiles)).*";	//不对匹配该值的访问路径拦截（正则）
